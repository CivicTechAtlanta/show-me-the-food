class Location < ApplicationRecord
  ...
  # already have coordinates (rows seeded with coordinates, like GA-EBT.csv,
  # must not be re-geocoded). Bulk backfill belongs in
  # `bin/rails geocode:backfill`, not per-record saves.
  def needs_geocoding?
